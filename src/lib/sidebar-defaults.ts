...
export const AVAILABLE_ITEMS_BY_ROLE: Record<string, { key: string; defaultLabel: string; route: string }[]> = {
  ...
  responsavel: [
    ...
    { key: 'financeiro', defaultLabel: 'Financeiro', route: '/responsavel/financeiro' },
  ],
  aluno: [
  ...
  secretaria: [
    ...
    { key: 'usuarios', defaultLabel: 'Usuários', route: '/secretaria/usuarios' },
    { key: 'feriados', defaultLabel: 'Feriados', route: '/secretaria/feriados' },
    { key: 'calendario', defaultLabel: 'Calendário', route: '/secretaria/calendario' },
    ...
    { key: 'financeiro', defaultLabel: 'Financeiro', route: '/secretaria/financeiro' },
  ],
  admin: [
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { key: 'financeiro', label: 'Financeiro', ordem: 6, visible: true },
        ],
      },
    ];
  }
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { key: 'financeiro', label: 'Financeiro', ordem: 16, visible: true },
        ],
      },
    ];
  }
  ...
  if (perfil === 'secretaria') {
    return [
      ...
      },
      {
        ...
        ordem: 1,
        items: [
          { key: 'presencas', label: 'Presenças', ordem: 0, visible: true },
          { key: 'eventos', label: 'Eventos Diários', ordem: 1, visible: true },
          { key: 'membros', label: 'Corpo Docente', ordem: 2, visible: true },
          { key: 'turmas', label: 'Turmas', ordem: 3, visible: true },
          { key: 'alunos', label: 'Alunos', ordem: 4, visible: true },
          { key: 'usuarios', label: 'Usuários', ordem: 5, visible: true },
          { key: 'feriados', label: 'Feriados', ordem: 6, visible: true },
          { key: 'calendario', label: 'Calendário', ordem: 7, visible: true },
          { key: 'relatorios', label: 'Relatórios', ordem: 8, visible: true },
          { key: 'relatorio_aluno', label: 'Relatório Aluno', ordem: 9, visible: true },
          { key: 'materias', label: 'Matérias', ordem: 10, visible: true },
          { key: 'boletim', label: 'Boletim', ordem: 11, visible: true },
          { key: 'grade_aulas', label: 'Grade de Aulas', ordem: 12, visible: true },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { key: 'suporte', label: 'Suporte', ordem: 11, visible: true },
          { key: 'sidebar_config', label: 'Menu Lateral', ordem: 12, visible: true },
          ...
          { key: 'financeiro', label: 'Financeiro', ordem: 19, visible: true },
